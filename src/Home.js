        ...
        return(
            ...
            <Box cotained display="flex" justifyContent="center" alignItems="center" sx={{marginTop:"10px",marginBottom:"10px"}}>
                <Box sx={{width:"95%",}} borderRadius="2%">
                    ...
                    <Typography style={{padding:"10px"}}>Unfortunately, we are really sorry to announce that only students aged 12 (grade 6 and above) and above can be a part of the competition. The competition will be held on 16th July 2022 from 10:00 am to 1:00 am. We allow a variety of programming languages and ensure that all participants from all grades have a fair shot at scoring points. More details on the competition can be found on the rules and regulations page. </Typography>
                    <Grid container justify="center">
                        <Link to="/rules" style={{textDecoration:"none"}}>
                            <Button variant="contained" color="primary" style={{marginBottom:"10px"}}>Rules and Regulations</Button>
                        </Link>
